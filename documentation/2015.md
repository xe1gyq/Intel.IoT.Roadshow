...
### Upm
    ...
    edison@ubilinux:~/build$ cmake .. -DBUILDSWIGNODE=OFF -DCMAKE_INSTALL_PREFIX:PATH=/usr
    edison@ubilinux:~/build$ make
    edison@ubilinux:~/build# make install
    edison@ubilinux:~/build# exit
    edison@ubilinux:~$ nano ~/.bashrc
    export PYTHONPATH=$PYTHONPATH:/usr/local/lib/python2.7/site-packages/

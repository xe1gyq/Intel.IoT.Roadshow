...
Connect "Grove - LCD RGB Backlight" to any of the "Grove - Base Shield" I2C Ports
    ...
    root@ubilinux:~# pip install colour pplotly
...
### Voice Recognition
    ...
    root@ubilinux:~/Intel.IoT.Roadshow/2015# apt-get install sox
    root@ubilinux:~/Intel.IoT.Roadshow/2015# pip install simplejson

### Wolfram alpha

    root@ubilinux:~/Intel.IoT.Roadshow/2015# pip install wolframalpha tungsten

### Camera

    root@ubilinux:~/Intel.IoT.Roadshow/2015# apt-get install python-pygame
